...
it('works when unmocked', () => {
    jest.mocked(childProcess).execFileSync.mockImplementation(jest.requireActual('child_process').execFileSync); // you may want to move this to the module level if you don't want to explicity do this each test
